...
const normalizeComplaint = (complaint, options = {}) => {
  ...
  return {
    ...
    evidencePublicId: complaint.evidencePublicId || "",
    evidenceResourceType: complaint.evidenceResourceType || "",
    evidenceMimeType: complaint.evidenceMimeType || complaint.evidenceType || "",
    evidenceType: complaint.evidenceType || complaint.evidenceMimeType || "",
    evidenceName: complaint.evidenceName || "",
    evidenceSize: complaint.evidenceSize || 0,
